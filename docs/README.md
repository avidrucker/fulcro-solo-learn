...
| [`UX_research_findings.md`](./UX_research_findings.md) | **UX heuristic eval** — researcher-as-proxy pass over copy / flows / affordances, with severity-ranked findings + recommended fix order | A UX-shaped issue is noticed; promote individual findings to `task_suggestions.md` (or directly to phases) when actionable |
